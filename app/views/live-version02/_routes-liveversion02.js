...
module.exports = function (folderForViews, urlPrefix, router) {
  ...
  router.post('/live-version02/patient-details/find-patient-address-answer', function (req, res) {
    ...
    res.redirect('/live-version02/patient-details/patient-address-results')
  }
  )
